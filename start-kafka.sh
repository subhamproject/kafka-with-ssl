...
echo "listeners=SSL://kafka${BROKER_ID}:9092" >> /broker/kafka${BROKER_ID}.properties
echo "advertised.listeners=SSL://kafka${BROKER_ID}:9092" >> /broker/kafka${BROKER_ID}.properties

...
CMD_1="kafka.tools.GetOffsetShell --bootstrap-server kafka1:9092,kafka2:9092,kafka3:9092 --command-config /tmp/root.properties --topic $KAFKA_TOPIC --time -1"
CMD_2="kafka.tools.GetOffsetShell --bootstrap-server kafka1:9092,kafka2:9092,kafka3:9092 --command-config /tmp/root.properties --topic $KAFKA_TOPIC --time -2"
